    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            >
                <div class="flex items-center gap-4">
                    <div class="w-16 h-16 rounded-full overflow-hidden bg-gray-100 border border-gray-200">
                        <img
                            src="{{ $existingProfilePicture ? Storage::url($existingProfilePicture) : asset('images/avatar.png') }}"
                            alt="Profile Picture"
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full rounded-lg border-gray-300 bg-gray-100
                               ...
                               focus:ring-0 focus:border-gray-300 p-2"
                    >
                </div>
        ...
        <div class="border-t border-gray-200 p-6">
            ...
            >
                ...
                <div class="flex items-center justify-center p-3 h-32 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 mb-4">
